...
const audiences = [
  { title: 'Creators', description: 'Amplify your voice and nurture your audience with personalised, effortless outreach.', image: '/images/1.jpg' },
  { title: 'Developers', description: 'Integrate powerful networking tools seamlessly into your apps and workflows.', image: '/images/2.jpg' },
  { title: 'Business', description: 'Streamline relationship management and boost your professional network\'s value.', image: '/images/3.jpg' },
  { title: 'Sales', description: 'Help customers find accurate answers when and where they need them.', image: '/images/4.jpg' },
];
      ...
      <div className='container mx-auto'>
        ...
        >
          <div className="h-full flex flex-col justify-between">
            <motion.h2 className={cn("text-4xl font-serif font-bold mb-6", headingFont.className)}>Tailored Email Solutions for Every Professional</motion.h2>

            {/* Mobile Accordion */}
            <div className="lg:hidden">
              <Accordion type="single" collapsible onValueChange={handleAccordionChange}>
                {audiences.map((audience) => (
                  <AccordionItem key={audience.title} value={audience.title} className='border-t border-b-0 first:border-t-0'>
                    ...
                    <AccordionPrimitive.Header asChild>
                      <AccordionPrimitive.Trigger asChild>
                        <div className='flex flex-col py-4 cursor-pointer text-gray-600 hover:text-foreground transition-all data-[state=open]:text-foreground'>
                          <span className='text-lg font-semibold'>{audience.title}</span>
                          <span className='text-sm'>{audience.description}</span>
                        </div>
              ...
              {audiences.map((audience, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    currentAudience === index ? "text-foreground" : "text-gray-400"
                  )}
