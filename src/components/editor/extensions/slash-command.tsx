...
const CommandList = ({
	items,
	command,
}: { items: CommandItemProps[]; command: any }) => {
	...
	return (
		<div className="bg-background rounded-md shadow-md z-50 h-auto w-36 overflow-y-auto max-h-[300px] border border-border py-2 px-1 transition-all duration-100">
			{items.map((item: CommandItemProps, index: number) => (
				<button
					key={index}
					className="w-full p-2 hover:bg-muted text-left text-sm"
