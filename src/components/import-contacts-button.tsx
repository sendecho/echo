			...
			<DialogContent>
				...
				<div className="mb-4">
					<p className="text-sm text-gray-500 mb-2">
						Please ensure your CSV file has the following columns: first_name,
						last_name, email, phone_number, lists (comma-separated list IDs)
					</p>
