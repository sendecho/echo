...
export default function MailingAddressForm({ initialMailingAddress }: MailingAddressFormProps) {
    ...
    <FormProvider {...methods}>
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardFooter className="flex justify-between">
          <Button variant="outline" onClick={() => router.push('/onboarding/domain-verification')}>Back</Button>
          <SubmitButton onClick={onSubmit} disabled={status === 'executing'} isSubmitting={status === 'executing'}>
