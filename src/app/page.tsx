    ...
    <div className="min-h-screen bg-gray-100 dark:bg-background">
      ...
      <div className='container mx-auto relative flex flex-col justify-center antialiased pt-36 pb-24'>
        <div className="grid md:grid-cols-2">
          <div className="relative z-10 flex flex-col justify-center">
            ...
            <h1 className={cn("text-5xl lg:text-7xl font-heading leading-none bg-gradient-to-r from-gray-700 via-gray-900 to-black  dark:from-sky-200 dark:via-purple-300 dark:to-indigo-300 bg-clip-text text-transparent my-4", headingFont.className)}>Introducing Echo:<br /><span className="italic">Personal Newsletters</span><br />Amplified</h1>
      ...
      <main className="text-center">
        ...
        <section className="container mt-24 max-w-xl mx-auto pb-24">
          <h2 className={cn("text-2xl mb-8", headingFont.className)}>Frequently Asked Questions</h2>
